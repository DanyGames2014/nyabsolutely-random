...
public class SunglassesItem extends GlassesItem {
    public SunglassesItem(Identifier identifier) {
        super(identifier);
    }
    ...
    public void constructRenderer() {
        this.texture = "/assets/nyabsolutelyrandom/stationapi/textures/accessory/glasses/sunglasses.png";
